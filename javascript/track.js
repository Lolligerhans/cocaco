...
class Track {
    ...
    constructor() {
        ...
        // Generated by updateRollsData() only. Avoid computation while not needed.
        {
            // Copy of the first K values of 'rolls'. Tracks how much was
            // processed w/ the same interface as using 'rolls' after every new
            // entry.
            this.rollsProcessed = [];
    ...
    // and then pretending rollsProcessed is the live array. Later maybe just
    // iterate 'rolls  and have a counter.
    // This makes the main loop and render timers more representative, too.
    updateRollsData() {
